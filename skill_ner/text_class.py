...
#
# my packs
from skill_ner.cleaner import Cleaner, stem_text, find_index_phrase
from skill_ner.general_params import S_GRAM_REDUNDANT
...
class Word:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from skill_ner.text_class import Word
        >>> word_obj = Word("Hello")
        """
